...
<html>
    <head>
        ...
        <title>Partly Paid Claims</title>
        <script>
            var page = {
                bootstrap: 3
            };
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <div class="dt-responsive table-responsive tablehide">
                                                    ...
                                                    <table id="simpletable" class="table table-striped table-bordered nowrap display compact">
                                                        <thead>
                                                            <tr>
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                ...
                if (partydenialdt === null) {
                    ...
                    localStorage.setItem("partydenialdate", moment(start).format("MM/DD/YYYY") + ' / ' + moment(end).format("MM/DD/YYYY"));
                }
                ...
                function getTotalPartlyDenialValue(startDate, endDate, para, paraVal) {
                    $.ajax({
                        url: "total-partly-denial-value",
                ...
                function exportOption() {
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            csvContent += "File,Claim,Payor ICN,Status,Payor,Payee,Charge,Paid,PR,CR-Date,Patient,D-Status,Elapsed,Action_Taken\n";
                            ...
                            link.setAttribute("download", "PartlyPaidClaims.csv");
                ...
                var table = $('#simpletable').DataTable({
                    "aaSorting": [], // Sort by first column descending  [10, "desc"]
                    ...
                    "columnDefs": [
                        {'visible': false, 'targets': [13, 14, 15, 16, 18, 19, 20, 21, 22, 23, 24, 27, 30], 'className': 'dt-body-center'}
                    ],
                    ...
                    "columns": [
                        ...
                        {"data": function (data) {
                                return "<a class='vu-idbole' target='_blank' href= 'patientwise?rid=" + data.claimno + "&pr=" + data.patientres + "&icn=" + data.payericn + "&payer=" + data.payer + "&file=" + data.fn + "&payee=" + data.payee + "~" + data.patient + "" + "" + "~" + data.fn + "~" + data.chargeamt + "~" + data.paidamt + "~" + data.insid + "~" + data.inslname + ", " + data.insfname + "~" + data.rendproid + "~" + data.rendprolname + ", " + data.rendprofname + "'>" + data.claimno + "</a>";
                            },
                    ...
                    buttons: [
                        {
                            ...
                            exportOptions: {
                                columns: [1, 2, 3, 4, 23, 24, 7, 8, 9, 22, 30, 12, 25, 15]
                            },
                    ...
                    createdRow: function (row, data, dataIndex) {
                        ...
                        $(row).find('td:eq(11)').attr('data-original-title', data["patient"]);
                        $(row).find('td:eq(10)').text(data["recdate"].toString());
                        var ticket_id = $(row).find('td:eq(15)').find('span').find('span').text();
                        ...
                        if (ticket_id !== "0") {
                            ...
                            $(row).find('td:eq(15)').attr('data-original-title', "By: " + data["action_taken_by"] + "<br>" + "To: " + data["assign_to"]);
                        } else {
                            $(row).find('td:eq(15)').find('span').find('a').removeAttr('target');
                            $(row).find('td:eq(15)').find('span').find('a').removeAttr('href');
                        }
                    },
                ...
                getTotalPartlyDenialValue(moment(start).format("YYYY-MM-DD"), moment(end).format("YYYY-MM-DD"), '', '');

                function exportOptionPDF() {
                    $('#flading').show();
                    var startDate = moment(start).format("YYYY-MM-DD");
                    var endDate = moment(end).format("YYYY-MM-DD");
                    location.href = "exportPartyDenialPdf?startDate=" + startDate + "&endDate=" + endDate;
                    $('#flading').hide();
                }
                ...
                $('#pc-daterangepicker-6').daterangepicker({
                    ...
                    localStorage.setItem("partydenialdate", startVal.format("MM/DD/YYYY") + ' / ' + endVal.format("MM/DD/YYYY"));
                    table.ajax.url("partyDenialData?startDate=" + start + "&endDate=" + end).load();
                    getTotalPartlyDenialValue(moment(start).format("YYYY-MM-DD"), moment(end).format("YYYY-MM-DD"), para, paraVal);
                ...
                $('#search').click(function () {
                    ...
                    if (searchOption === '0') {
                        msgbox("Select the Search option..!", "Partly Denial Portal", "error");
                        table.search('').columns().search('').draw();
                        $('#flading').hide();
                        ...
                        if (lenFirstName !== 0) {
                            ...
                            msgbox("Enter File Name..!", "Partly Paid Portal", "error");
                            $('#flading').hide();
                        }
                        ...
                        if (lenClaim !== 0) {
                            ...
                            msgbox("Enter Claim..!", "Partly Paid Portal", "error");
                            $('#flading').hide();
                        }
                        ...
                        if (lenIcn !== 0) {
                            ...
                            msgbox("Enter Payor ICN..!", "Partly Denial Portal", "error");
                            $('#flading').hide();
                        }
                        ...
                        if (lenPayor !== 0) {
                            ...
                            // table.ajax.url("partyDenialSearchData?para=eob.payer&paraVal=" + $('#para_payor').val()).load();
                            para = 'eob.payer';
                            paraVal = $('#para_payor').val();
                            searchColumn = 'payer';
                            searchValue = $('#para_payor').val();
                        } else {
                            msgbox("Enter Payor..!", "Partly Denial Portal", "error");
                            $('#flading').hide();
                        }
                        ...
                        if (lenPractice !== 0) {
                            ...
                            msgbox("Enter Practice..!", "Partly Denial Portal", "error");
                            $('#flading').hide();
                        }
                        ...
                        if (lenFirstName !== 0) {
                            ...
                            table.columns(11).search('').search($('#para_Firstname').val()).draw();
                            para = 'cd.fname';
                            paraVal = $('#para_Firstname').val();
                            searchColumn = 'patient';
                            searchValue = $('#para_Firstname').val();
                        } else {
                            msgbox("Enter First Name..!", "Partly Denial Portal", "error");
                            $('#flading').hide();
                        }
                        ...
                        if (lenLastName !== 0) {
                            ...
                            table.columns(11).search('').search($('#para_Lastname').val()).draw();
                            para = 'cd.lname';
                            paraVal = $('#para_Lastname').val();
                            searchColumn = 'patient';
                            searchValue = $('#para_Lastname').val();
                        } else {
                            msgbox("Enter Last Name..!", "Partly Denial Portal", "error");
                            $('#flading').hide();
                        }
                        ...
                        if (lenNpi !== 0) {
                            ...
                            clearFields();
                            $('#para_npi').val(npiVal);
                            table.columns(20).search('').search($('#para_npi').val()).draw();
                            para = 'eob.billing_npi';
                            paraVal = $('#para_npi').val();
                            searchColumn = 'billing_npi';
                            searchValue = $('#para_npi').val();
                        } else {
                            msgbox("Enter Billing NPI..!", "Partly Denial Portal", "error");
                            $('#flading').hide();
                        }
                    }
                    getTotalPartlyDenialValue(moment(start).format("YYYY-MM-DD"), moment(end).format("YYYY-MM-DD"), para, paraVal);
                ...
                if (typeof (not_tid) !== 'undefined') {
                    table.columns(17).search('').search(not_tid).draw();
                    $('#qv2').find('#card1').html('');
                } else {
                    table.columns(17).search('').search('').draw();
                }
                ...
                $('#raiseticket').click(function () {
                    ...
                    table.$('input[type="checkbox"]').each(function () {
                        if (this.checked) {
                            ...
                            brid = tr.find('td:eq(13)').text() + ',' + brid;
                        }
                    });
                    ...
                    if (brid !== '') {
                        ...
                        msgbox("select atleast one Claim..!", "Ticket Portal", "warning");
                    }
                });
                $(function () {
                ...
                $("form").submit(function () {
                    ...
                    if ($("select#assigned_to").val() !== "0") {
                        var strcontent = "Hi " + assignto + ", <br><br>" + "Type: " + tickettype + "<br>Source: " + tsource + "<br>Priority: " + ticketpriority + "<br> Assign To: " + assignto + "<br>Segment: Partly Denial Claims [P]" + "<br><br>" + $(".note-editable").html();
                        // Email Config
                        $.post('eMail', {
                            recipient: entity_user_to,
                            subject: 'Ticket Raised from Partly Denial Claims Form: ' + tickettype + ' : ' + tstatus + ' to ' + assignto,
                            content: strcontent,
                            cc: entity_user_cc,
                            bcc: entity_user_bcc
                        }, function (response) {
