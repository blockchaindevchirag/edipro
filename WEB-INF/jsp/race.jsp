...
<html>
                    ...
                    <div class="pcoded-inner-content">
                        <div class="main-body">
                            <div class="page-wrapper">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                    <sec:authorize access="hasAuthority('NEW_RACE_PRIVILEGE')">
                                        <button class="btn btn-rounded btn-greenadd md-trigger"  data-modal="modal-1" id="headeradd">Add Race</button>
                                    </sec:authorize>
                                            ...
                                            <div class="card-body">
                                                <div class="dt-responsive table-responsive">
                                                    <table id="simpletable" width="98%" class="table table-striped table-bordered nowrap">
                                                        ...
                                                        <tbody>
                                                        <c:forEach var="patients" items="${racelist}">

                                                            <tr>
                                                                <td>${patients.ddlraceid}</td>
                                                                <td>${patients.ddlrace}</td> 

                                                                <td><input class="row-data" type="text" name="First" value=${patients.ddlrace} ></td>
                                                                <td> 
                                                                    <sec:authorize access="hasAuthority('EDIT_RACE_PRIVILEGE')">
    ...
    <div class="md-modal md-effect-1" id="modal-1">
        <div class="md-content">
            <h3 class="model-bg-custom">Race <button type="button" id="model_close" class="close" style="font-size:24px; padding-left:20px" data-dismiss="modal" aria-hidden="true">X</button></h3>
            <div>
                <form:form method="POST" id="race"  action="addrace" modelAttribute="addrace">
                    <div class="form-group">
                        <span class="text-danger">*</span>
                        <input type="text" class="form-control" required name="race" id = "race" placeholder="Enter Race">
                    </div>
                    <br>
                 ...
                 $.ajax({
                    ...
                    success: function (response) {
                         console.log(response);
                          msgbox("Record Saved", "Race Form", "success");
                    },
                    error: function (err) {
                        console.log(err);
                         msgbox("Record Not Saved", "Race Form", "error: " + err);
                    }
                });
