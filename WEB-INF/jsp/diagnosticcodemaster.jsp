                    ...
                    <div class="pcoded-inner-content">
                        <div class="main-body">
                            <div class="page-wrapper">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <sec:authorize access="hasAuthority('NEW_DIAGNOSTIC_CODE_PRIVILEGE')">
                                        <button class="btn btn-rounded btn-greenadd md-trigger" id="btndiag"  data-modal="modal-1">Add Diagnostic Code</button>
                                         </sec:authorize>
                                        <br><br>
                                    </div>
                                </div>
                                            ...
                                            <div class="card-body">
                                                <div class="dt-responsive table-responsive">
                                                    <table id="simpletable" class="table table-striped table-bordered nowrap">
                                                        ...
                                                        <tbody>
                                                        <c:forEach var="code" items="${diagcodemasterlist}">

                                                            <tr>
                                                                <td>${code.tid}</td>
                                                                <td>${code.dcode}</td>
                                                                <td><input class="row-data" type="text" name="First" value="${code.dcode}" ></td>
                                                                <td>${code.ddesc}</td> 
                                                                <td><input class="row-data" type="text" name="First" value="${code.ddesc}" ></td>
                                                                <td> 
                                                                    <sec:authorize access="hasAuthority('EDIT_DIAGNOSTIC_CODE_PRIVILEGE')">
        ...
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Diagnostic Code master</h4>
                ...
                <div class="modal-body">
                    <form:form method="POST" id="diagnosticcodemaster"  action="adddiagcodemaster" modelAttribute="adddiagcodemaster">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" required name="dcode" id = "dcode" placeholder="Enter code">
                        </div>
                        <div class="form-group">
                            <span class="text-danger">*</span>
                            <input type="text" class="form-control" required name="ddesc" id = "ddesc" placeholder="Enter description">
                        </div>
                        <br>
