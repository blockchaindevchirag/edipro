...
<html>
                    ...
                    <div class="pcoded-inner-content">
                        <div class="main-body">
                            <div class="page-wrapper">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                    <sec:authorize access="hasAuthority('NEW_SMOKING_PRIVILEGE')">
                                        <button class="btn btn-rounded btn-greenadd md-trigger"  data-modal="modal-1" id="headeradd">Add Smoking</button>
                                    </sec:authorize>
                                            ...
                                            <div class="card-body">
                                                <div class="dt-responsive table-responsive">
                                                    <table id="simpletable" class="table table-striped table-bordered nowrap">
                                                        ...
                                                        <tbody>
                                                        <c:forEach var="patients" items="${smokinglist}">

                                                            <tr>
                                                                <td>${patients.ddlsmokingid}</td>
                                                                <td>${patients.ddlsmoking}</td> 

                                                                <td><input class="row-data" type="text" name="First" value=${patients.ddlsmoking} ></td>
                                                                <td> 
                                                                    <sec:authorize access="hasAuthority('EDIT_SMOKING_PRIVILEGE')">
    ...
    <div class="md-modal md-effect-1" id="modal-1">
        <div class="md-content">
            <h3 class="model-bg-custom">Smoking <button type="button" id="model_close" class="close" style="font-size:24px; padding-left:20px" data-dismiss="modal" aria-hidden="true">X</button></h3>
            <div>
                <form:form method="POST" id="smoking"  action="addsmoking" modelAttribute="addsmoking">
                    <div class="form-group">
                        <span class="text-danger">*</span>
                        <input type="text" class="form-control" required name="smoking" id = "smoking" placeholder="Enter Smoking">
                    </div>
                        <br>
                 ...
                 $.ajax({
                    ...
                    success: function (response) {
                         console.log(response);
                          msgbox("Record Saved", "Smoking Form", "success");
                    },
                    error: function (err) {
                        console.log(err);
                         msgbox("Record Not Saved", "Smoking Form", "error: " + err);
                    }
                });
