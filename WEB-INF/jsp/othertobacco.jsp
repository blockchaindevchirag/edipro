...
<html>
                    ...
                    <div class="pcoded-inner-content">
                        <div class="main-body">
                            <div class="page-wrapper">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                    <sec:authorize access="hasAuthority('NEW_OTHER_TOBACCO_PRIVILEGE')">
                                        <button class="btn btn-rounded btn-greenadd md-trigger"  data-modal="modal-1" id="headeradd">Add Other Tobacco</button>
                                    </sec:authorize>
                                            ...
                                            <div class="card-body">
                                                <div class="dt-responsive table-responsive">
                                                    <table id="simpletable" class="table table-striped table-bordered nowrap">
                                                        ...
                                                        <tbody>
                                                        <c:forEach var="patients" items="${othertobaccolist}">

                                                            <tr>
                                                                <td>${patients.ddlothertobid}</td>
                                                                <td>${patients.ddlothertob}</td> 

                                                                <td><input class="row-data" type="text" name="First" value=${patients.ddlothertob} ></td>
                                                                <td>
                                                                    <sec:authorize access="hasAuthority('EDIT_OTHER_TOBACCO_PRIVILEGE')">
    ...
    <div class="md-modal md-effect-1" id="modal-1">
        <div class="md-content">
            <h3 class="model-bg-custom">Other Tobacco <button type="button" id="model_close" class="close" style="font-size:24px; padding-left:20px" data-dismiss="modal" aria-hidden="true">X</button></h3>
            <div>
                <form:form method="POST" id="othertobacco"  action="addothertobacco" modelAttribute="addothertobacco">
                    <div class="form-group">
                        <span class="text-danger">*</span>
                        <input type="text" class="form-control" required name="othertobacco" id = "othertobacco" placeholder="Enter Other Tobacco">
                    </div>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $(document).on("click", "#simpletable button.editbutton", function () {
                ...
                $.ajax({
                    url: "editothertobaccodetails",
                    type: "get", //send it through get method
                    data: {
                        othertobacco_val: a + "~" + b
                    },
                    success: function (response) {
                        console.log(response);
                        msgbox("Record Saved", "Other Tobacco Form", "success");
                    },
                    error: function (err) {
                        console.log(err);
                        msgbox("Record Not Saved", "Other Tobacco Form", "error: " + err);
                    }
                });
