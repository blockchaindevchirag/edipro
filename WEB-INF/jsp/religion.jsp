...
<html>
                    ...
                    <div class="pcoded-inner-content">
                        <div class="main-body">
                            <div class="page-wrapper">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <sec:authorize access="hasAuthority('NEW_RELIGION_PRIVILEGE')">
                                             <button class="btn btn-rounded btn-greenadd md-trigger"  data-modal="modal-1" id="headeradd">Add Religion</button>
                                        </sec:authorize>
                                            ...
                                            <div class="card-body">
                                                <div class="dt-responsive table-responsive">
                                                    <table id="simpletable" class="table table-striped table-bordered nowrap">
                                                        ...
                                                        <tbody>
                                                        <c:forEach var="patients" items="${religionlist}">

                                                            <tr>
                                                                <td>${patients.ddlreligionid}</td>
                                                                <td>${patients.ddlreligion}</td> 

                                                                <td><input class="row-data" type="text" name="First" value=${patients.ddlreligion} ></td>
                                                                <td>
                                                                    <sec:authorize access="hasAuthority('EDIT_RELIGION_PRIVILEGE')">
    ...
    <div class="md-modal md-effect-1" id="modal-1">
        <div class="md-content">
            <h3 class="model-bg-custom">Religion <button type="button" id="model_close" class="close" style="font-size:24px; padding-left:20px" data-dismiss="modal" aria-hidden="true">X</button></h3>
            <div>
                <form:form method="POST" id="religion"  action="addreligion" modelAttribute="addreligion">
                    <div class="form-group">
                        <span class="text-danger">*</span>
                        <input type="text" class="form-control" required name="religion" id = "religion" placeholder="Enter Religion">
                    </div>
                    <br>
