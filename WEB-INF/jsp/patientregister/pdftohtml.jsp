                                            ...
                                            <div class="card">
                                                ...
                                                <div class="card-body p-2">
                                                    ...
                                                    <div class="card-header px-0">
                                                        <div class="row">
                                                            <div class="col-md-12 col-lg-4 col-xl-4 mb-50">
                                                                <img src="assets/images/MedenDx_green-slogan.png" alt="company-logo" height="46"
                                                                     width="164">
                                                                <p>3, Corozal, Foothill Ranch, CA - 92610</br>
                                                                    billing@ameridenti.com</br>
                                                                    +(866) 508-9491</p>
                                                            </div>
                                                            <div class="col-lg-4 col-md-12 col-xl-4 mt-4">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-12">
                                                                            <span class="d-block">
                                                                                ...
                                                                                <a id="eft" target="_blank"><span class="float-right f-w-400"></span> </a>                                                   
                                                                            </span>
                                                                            <span class="d-block">
                                                                ...
                                                                <div class="card-body card-task">
                                                                    <table>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>&emsp;:&emsp;</td>
                                                                            <td><span id="originalinv"></span></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <th>UPDATED INVOICE $ </th>
                                                                            <td>&emsp;:&emsp;</td>
                                                                            <td> <span id="updatedinv"></span></td>
                                                                        </tr>
                                                        ...
                                                        <table id="simpletable" width="100%" class="table table-borderless table-striped">
                                                            ...
                                                            <c:forEach var="Claim" items="${claimlistera}">
                                                                <tr style="text-align: center">
                                                                    ...
                                                                    <td>${Claim.covered}</td>
                                                                    <td class="font-weight-bold" style="text-align: end; margin: 15px;"></td>
                                                                </tr>
                                                            </c:forEach>
                                                ...
                                                <div class="invoice-total py-2">
                                                    <div class="row">
                                                        <div class="col-4 col-sm-8 mt-75">
                                                            <img src="assets/images/paid.png" alt="paid" class="p-5" style="margin: auto;display: block;" >   
                                                        </div>
                                ...
                                <div class="col-sm-12">
                                    <div class="card select-card">
                                        <div class="card-body" id="privilegeContainer">
                                            <div style="padding:50px;">Please choose user by filtering role to view the privileges for that particular user</div></div>
                                    </div>
                                </div>
                                <!-- [ Invoice-right ] end -->
           ...
           /* $.get('getpracticedetails', {
            ...
            if (typeof (eft) !== "undefined")
            {
                ...
                $('#simpletable').find('tbody').find('tr').each(function (index) {
                    ...
                    tp = tp + inv;
                    $(this).find('td:eq(5)').text(inv.toFixed(2));
