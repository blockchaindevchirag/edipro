                    ...
                    <div class="pcoded-inner-content">
                        <div class="main-body">
                            <div class="page-wrapper">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                    <sec:authorize access="hasAuthority('NEW_MARITAL_STATUS_PRIVILEGE')">
                                     <button class="btn btn-rounded btn-greenadd md-trigger"  data-modal="modal-1" id="headeradd">Add Marital Status</button>
                                    </sec:authorize>                                       
                                        <br><br>
                                    </div>
                                </div>
                                            ...
                                            <div class="card-body">
                                                <div class="dt-responsive table-responsive">
                                                    <table id="simpletable" class="table table-striped table-bordered nowrap">
                                                        ...
                                                        <tbody>
                                                        <c:forEach var="patients" items="${maritalstatuslist}">

                                                            <tr>
                                                                <td>${patients.ddlmaritalid}</td>
                                                                <td>${patients.ddlmarital}</td> 

                                                                <td><input class="row-data" type="text" name="First" value=${patients.ddlmarital} ></td>
                                                                <td> 
                                                                    <sec:authorize access="hasAuthority('EDIT_MARITAL_STATUS_PRIVILEGE')">
        ...
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form:form method="POST" id="maritalstatus"  action="addmaritalstatus" modelAttribute="addmaritalstatus">
                        <div class="form-group">
                            <span class="text-danger">*</span>
                            <input type="text" class="form-control" required name="maritalstatus" id = "maritalstatus" placeholder="Enter Marital Status">
                        </div>
                        <br>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $(document).on("click", "#simpletable button.editbutton", function () {
                ...
                $.ajax({
                    url: "editmaritalstatusdetails",
                    type: "get", //send it through get method
                    data: {
                        maritalstatus_val: a + "~" + b
                    },
                    success: function (response) {
                        console.log(response);
                        msgbox("Record Saved", "Marital Status Form", "success");
                    },
                    error: function (err) {
                        console.log(err);
                        msgbox("Record Not Saved", "Marital Status Form", "error: " + err);
                    }
                });
