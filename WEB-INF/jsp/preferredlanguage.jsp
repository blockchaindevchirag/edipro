...
<html>
                    ...
                    <div class="pcoded-inner-content">
                        <div class="main-body">
                            <div class="page-wrapper">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                    <sec:authorize access="hasAuthority('NEW_PREFERRED_LANG_PRIVILEGE')">
                                        <button class="btn btn-rounded btn-greenadd md-trigger"  data-modal="modal-1" id="headeradd">Add Preferred Language</button>
                                    </sec:authorize>
                                            ...
                                            <div class="card-body">
                                                <div class="dt-responsive table-responsive">
                                                    <table id="simpletable" class="table table-striped table-bordered nowrap">
                                                        ...
                                                        <tbody>
                                                        <c:forEach var="patients" items="${preferredlanguagelist}">

                                                            <tr>
                                                                <td>${patients.ddlprelangid}</td>
                                                                <td>${patients.ddlprelang}</td> 

                                                                <td><input class="row-data" type="text" name="First" value=${patients.ddlprelang} ></td>
                                                                <td>
                                                                    <sec:authorize access="hasAuthority('EDIT_PREFERRED_LANG_PRIVILEGE')">
    ...
    <div class="md-modal md-effect-1" id="modal-1">
        <div class="md-content">
            <h3 class="model-bg-custom">Preferred Language <button type="button" id="model_close" class="close" style="font-size:24px; padding-left:20px" data-dismiss="modal" aria-hidden="true">X</button></h3>
            <div>
                <form:form method="POST" id="preferredlanguage"  action="addpreferredlanguage" modelAttribute="addpreferredlanguage">
                    <div class="form-group">
                        <span class="text-danger">*</span>
                        <input type="text" class="form-control" required name="preferredlanguage" id = "preferredlanguage" placeholder="Enter Preferred Language">
                    </div>
                    <br>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $(document).on("click", "#simpletable button.editbutton", function () {
                ...
                $.ajax({
                    url: "editpreferredlanguagedetails",
                    type: "get", //send it through get method
                    data: {
                        preferredlanguage_val: a + "~" + b
                    },
                    success: function (response) {
                        console.log(response);
                        msgbox("Record Saved", "Preferred Language Form", "success");
                    },
                    error: function (err) {
                        console.log(err);
                        msgbox("Record Not Saved", "Preferred Language Form", "error: " + err);
                    }
                });
