                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                            <form:form method="POST"   action="addpayormaster" modelAttribute="payormaster">
                                                <div class="row">

                                                    <!--      <div class="col-lg-4">
                                                              <label class="form-label"  for="ddlpractice">Practice<span class="text-danger">*</span></label>
                                                               <select class="form-control" tabindex="1" id="ddlpractice" tabindex="1" name="ddlpractice">
                                                              </select>
                                                          </div> -->
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" tabindex="3"  name="payor_id_universal" id="payor_id_universal" maxlength="24" required  placeholder="Enter payor code">
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input  class="form-control" tabindex="5" maxlength="48" required  name="addressline1" id="addressline1" placeholder="Enter Address Line 1"   >
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input  class="form-control" tabindex="6"  name="addressline2" id="addressline2" maxlength="48" placeholder="Enter Address Line 2"   >
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" tabindex="9" name="zip" maxlength="10"  id = "zip" placeholder="12345-1234" >
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="fax" tabindex="9" maxlength="24"  id = "fax" placeholder="Enter fax" >
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" id="alt_fax" tabindex="10" name="alt_fax" maxlength="24" placeholder="Enter your alternate fax" >
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="email" class="form-control" id="email" name="email" maxlength="48" tabindex="11" placeholder="Enter your email" >
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" id="contact_phone" tabindex="12" maxlength="24" name="contact_phone" placeholder="Enter your phone #" >
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" id="alt_phone" name="alt_phone" tabindex="13" maxlength="24" placeholder="Enter your Alternate phone #" >
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control" tabindex="14" required id="rte" name="rte" >
                                                                <option value = "" >--Select--</option> 
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control" tabindex="15" required id="rcs" name="rcs" >
                                                                <option value = "" >--Select--</option> 
                                                                <option value = "Yes" >Yes</option>
                                                                <option value = "No" >No</option>
                                                            </select> 
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control" tabindex="16" required id="eft" name="eft" >
                                                                <option value = "" >--Select--</option> 
                                                                <option value = "Yes" >Yes</option>
                                                                <option value = "No" >No</option>
                                                            </select> 
                                                ...
                                                <div class="row">    
                                                    <div class="col-md-3 offset-md-4">
                                                        <div class="form-group">
                                                            <button type="submit" tabindex="17" class="btn btn-rounded btn-greenadd btn-block">Submit</button>
