<%-- 
    Document   : ticketstatusmaster
    Created on : Nov 22, 2021, 3:23:16 PM
    Author     : Sheerin
--%>
...
<html>
                    ...
                    <div class="pcoded-inner-content">
                        <div class="main-body">
                            <div class="page-wrapper">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                    <sec:authorize access="hasAuthority('NEW_TICKET_STATUS_PRIVILEGE')">
                                        <button class="btn btn-rounded btn-greenadd md-trigger" id="btndoc"  data-modal="modal-1">Add Status</button>
                                    </sec:authorize>
                                            ...
                                            <div class="card-body">
                                                <div class="dt-responsive table-responsive">
                                                    <table id="simpletable" class="table table-striped table-bordered nowrap">
                                                        ...
                                                        <tbody>
                                                        <c:forEach var="tickets" items="${ticketstatuslist}">

                                                            <tr>
                                                                <td>${tickets.tid}</td>
                                                                <td>${tickets.ticket_status}</td> 

                                                                <td><input class="row-data" type="text" name="First" value=${tickets.ticket_status} ></td>
                                                                <td> 
                                                                    <sec:authorize access="hasAuthority('EDIT_TICKET_STATUS_PRIVILEGE')">
    ...
    <div class="md-modal md-effect-1" id="modal-1">
        <div class="md-content">
            <h3 class="model-bg-custom">Ticket status <button type="button" id="model_close" class="close" style="font-size:24px; padding-left:20px" data-dismiss="modal" aria-hidden="true">X</button></h3>
            <div>
                <form:form method="POST" id="ticketstatus"  action="addticketstatus" modelAttribute="addticketstatus">
                    <div class="form-group">
                        <span class="text-danger">*</span>
                        <input type="text" class="form-control" required name="ticket_status" id = "ticket_status" placeholder="Enter Ticket Status">
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                ...
                $(document).on("click", "#simpletable button.editbutton", function () {
                    ...
                    $.ajax({
                        url: "editticketstatusmasterdetails",
                        type: "get", //send it through get method
                        data: {
                            ticketstatus_val: a + "~" + b + "~" + c
                        },
                        success: function (response) {
                            console.log(response);
                            msgbox("Record Saved", "Ticket Status Form", "success");
                        },
                        error: function (err) {
                            console.log(err);
                            msgbox("Record Not Saved", "Ticket Status Form", "error: " + err);
                        }
                    }); 
                });
