...
<html>
                    ...
                    <div class="pcoded-inner-content">
                        <div class="main-body">
                            <div class="page-wrapper">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <sec:authorize access="hasAuthority('NEW_USER_TYPE_PRIVILEGE')">
                                        <button class="btn btn-rounded btn-greenadd md-trigger"  data-modal="modal-1" id="headeradd">Add User Type</button>                                            
                                        </sec:authorize>
                                                ...
                                                <div class="dt-responsive table-responsive">
                                                    <table id="simpletable" class="table table-striped table-bordered nowrap">
                                                        ...
                                                        <c:forEach var="benefits" items="${usertypelist}">
                                                            ...
                                                            <tr>
                                                                <td>${benefits.usertypeid}</td>
                                                                <td>${benefits.usertype}</td> 

                                                                <td><input class="row-data" type="text" name="First" value=${benefits.usertype} ></td>
                                                                <td> 
                                                                    <sec:authorize access="hasAuthority('EDIT_USER_TYPE_PRIVILEGE')">
    ...
    <div class="md-modal md-effect-1" id="modal-1">
        <div class="md-content">
            <h3 class="model-bg-custom">User Type <button type="button" id="model_close" class="close" style="font-size:24px; padding-left:20px" data-dismiss="modal" aria-hidden="true">X</button></h3>
            <div>
                <form:form method="POST" id="usertype"  action="addusertype" modelAttribute="addusertype">
                    <div class="form-group">
                        <span class="text-danger">*</span>
                        <input type="text" class="form-control" required name="usertype" id = "usertype" placeholder="Enter User Type">
                    </div>
                    <br>
                ...
                $.ajax({
                    ...
                    success: function (response) {
                         console.log(response);
                          msgbox("Record Saved", "User Type Form", "success");
                    },
                    error: function (err) {
                        console.log(err);
                         msgbox("Record Not Saved", "User Type Form", "error: " + err);
                    }
                });
