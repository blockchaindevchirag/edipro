                        ...
                        <div class="main-body">
                            <div class="page-wrapper">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12">
                                        <button type="button" onclick="addNew()" id="btnnew" class="btn btn-gradient-primary" title="btn btn-gradient-primary" data-toggle="tooltip">New Diagnosis Code</button>
