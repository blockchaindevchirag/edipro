                        ...
                        <div class="main-body">
                            <div class="page-wrapper">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12">
                                        <button type="button" onclick="addNew()" id="btnnew" class="btn btn-gradient-primary" title="btn btn-gradient-primary" data-toggle="tooltip">New Procedure Category</button>
                                            ...
                                            <div class="card-body ">
                                                ...
                                                <div class="card-body">
                                                    <div class="form-group">
                                                        <label class="form-label">Diagnosis Category Name</label>
                                                        <input type="text" class="form-control" placeholder="Diagnosis Category Name">
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="form-label">Diagnosis Category Desc</label>
                                                        <input type="text" class="form-control" placeholder="Diagnosis Category Desc">
                                                    </div>
                                                    <div class="form-group">
