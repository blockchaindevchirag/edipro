...
<html>
                                            ...
                                            <div class="card">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="modal-header">
                                                        <h4 class="modal-title" id="span_Prov">Invoice# : <span id="invoiceid"></span></h4>
                                                    </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            {
                $('#invoiceid').text(decodeURI(invid));
            ...
            $('#simpletable').find('tbody').find('tr').each(function (index) {
                ...
                tp = tp + parseFloat($(this).find('td:eq(5)').text());
            });

            $('#simpletable').find('tfoot').find('tr').each(function () {
                var tf = parseFloat(tp.toFixed(2));
                $(this).find('th:eq(0)').text("TOTAL FEE $: " + tf.toFixed(2));
