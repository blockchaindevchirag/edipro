  ...
  BootstrapDualListbox.prototype = {
    init: function () {
      ...
      this.container = $('' +
       ...
       // '       <i></i>' +
        '     </button>' +
        '     <button type="button" class="btn move" id="btnmove">' +
        '       Move Selected' +
        '     </button>' +
        '   </div>' +
    ...
    setBootstrap2Compatible: function(value, refresh) {
      ...
      if (value) {
       ...
       // this.container.find('.moveall > i, .move > i').removeClass('feather icon-arrow-right').addClass('feather icon-arrow-right');
       // this.container.find('.removeall > i, .remove > i').removeClass('feather icon-arrow-left').addClass('feather icon-arrow-left');
      //  this.container.find('.moveall > i, .move > i').html('Move All');
       // this.container.find('.removeall > i, .remove > i').html('Move Selected');
     ...
     //   this.container.find('.moveall > i, .move > i').removeClass('icon-arrow-right').addClass('feather icon-arrow-right');
      //  this.container.find('.removeall > i, .remove > i').removeClass('icon-arrow-left').addClass('feather icon-arrow-left');
      }
      if (refresh) {
        refreshSelects(this);
      }
